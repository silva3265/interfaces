...
public class Fazenda extends EmpresaFinanciavel {
	...
	@Override
	public double calcularLimiteAprovado() { // Implementamos ele seguindo a regra da Fazenda
		...
		if (getTamanhoEmHectares() >= TAMANHO_MINIMO_EM_HECTARES_GRANDE_PROPRIEDADE) {
			limiteAprovado *= TAXA_ACRESCIMO_LIMITE_PARA_GRANDE_PROPRIEDADE; // Vai acrescentar o Limite
		}
